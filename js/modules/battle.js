export class Battle {
    ...
    async start() {
        ...
        console.log(this.player1.activePokemon.speed)
        console.log(this.player2)
        console.log(this.player2.activePokemon.speed)
        while (this.player1.activePokemon.currentHealth > 0 && this.player2.activePokemon.currentHealth > 0) {
            ...
            console.log(`Vida restante de ${secondAttacker.activePokemon.name}: ${secondAttacker.activePokemon.currentHealth}`);
            await this.updateUI(this.player1.activePokemon, this.player2.activePokemon);
            ...
            console.log(`Vida restante de ${firstAttacker.activePokemon.name}: ${firstAttacker.activePokemon.currentHealth}`);
            await this.updateUI(this.player1.activePokemon, this.player2.activePokemon);
